...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2018 at 06:55 PM
...
INSERT INTO `assets` (`assetid`, `name`, `departmentid`, `status`, `locationid`, `supplierid`, `notes`, `purchaseprice`, `isdeleted`) VALUES
(2, 'Fan', '3', 0, 1, 1, 'Nothing to write about this', 115.97, 0),
(3, 'asa', '1', 0, 1, 0, '', 22.5, 0),
(5, 'er', '2', 1, 2, 1, '', 0, 0),
(6, 'qqwqqqq', '2', 1, 1, 1, 'qweqqw32', 1212, 0),
(7, 'Phone', '2', 1, 3, 1, 'A test work', 900, 0),
(8, 'Another one', '4', 0, 1, 1, 'What is the problem here?', 8988, 0),
(9, 'simply another one', '5', 1, 3, 1, 'just testing the location that is giving 1 all the time', 982, 0),
(10, 'a simple test', '1', 1, 2, 2, 'it was actually the supplier', 9900, 0),
(11, 'aaa', '3', 0, 2, 0, '23', 443, 1),
(12, 'to test', '4', 1, 2, 1, 'no notes, really', 988.2, 1);
...
(2, 'gloria ebortttt', '1990-08-03', 'male', 3, '324242', 'gloria@yahoo.com', 0, 1),
(4, 'ghkfhg', '0000-00-00', 'Female', 2, '5', 'jkhdkjfhkj@kkj.sd', 1, 1),
(5, 'dsgff', '1992-10-11', 'Male', 1, '45656', 'bonuzx1@gmial.com', 1, 0),
(6, 'dsgff', '1992-10-11', 'Male', 1, '45656', 'bonuzx1@gmial.com', 1, 1),
(7, 'asfa', '1992-10-11', 'Male', 1, '9087', 'ad@ksjnck.com', 1, 1),
(8, 'eqe', '1992-10-11', 'Female', 1, '22435235', 'fserws@adsd.com', 0, 1),
(9, 'eqe', '1992-10-11', 'Female', 1, '22435235', 'fserws@adsd.com', 0, 1),
(10, 'eqe', '1992-10-11', 'Female', 1, '22435235', 'fserws@adsd.com', 0, 1),
(11, 'eqe', '1992-10-11', 'Female', 1, '22435235', 'fserws@adsd.com', 0, 1),
...
--
ALTER TABLE `staff`
  MODIFY `staffid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
